...
function get_dashboard_nodes() {
    ...
    //     $("#nodes-table").empty();
    // }
    var data_url = '/pano/api/testdashboard';
    $('#example').DataTable({
        "ajax": "/pano/api/testdashboard",
        "autoWidth": false,
        "columnDefs": [
            {"title": "Certname", targets: 0},
            {"title": "Latest Catalogue", targets: 1},
            {"title": "Latest Report", targets: 2},
            {"title": "Latest Facts", targets: 3},
            {"title": "Success", targets: 4},
            {"title": "Noop", targets: 5},
            {"title": "Failure", targets: 6},
            {"title": "Skipped", targets: 7},
        ],
        "columns": [
            {"data": "certname"},
